...
public:
  ...
  compound&
  addCompound(const compound::ResidueNumber& resNum);

  compound&
  getCompound(const compound::ResidueNumber& resNum);
...
private:
  typedef std::map<compound::ResidueNumber, CompoundList::size_type>
   CompoundMap;
