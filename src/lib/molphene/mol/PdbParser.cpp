...
PdbParser::handle_atom_record_(Molecule* molptr)
{
  ...
  Compound::Residue_number resNum(arseq, arname, aicode);
...
PdbParser::handle_conect_record_(Molecule* molptr)
{
  ...
  for(auto& model : Molecule::Models_iterable{mol}) {
...
PdbParser::handle_ter_record_(Molecule* molptr)
{
    ...
    {"HIS",
     PdbParser::Bond_pairs(
      {{"N", "CA"},    {"N", "H"},     {"N", "H2"},    {"CA", "C"},
       ...
       {"CG", "CD2"},  {"ND1", "CE1"}, {"ND1", "HD1"}, {"CD2", "NE2"},
    ...
    {"ILE",
     PdbParser::Bond_pairs(
      {{"N", "CA"},     {"N", "H"},      {"N", "H2"},     {"CA", "C"},
       ...
       {"CG1", "HG12"}, {"CG1", "HG13"}, {"CG2", "HG21"}, {"CG2", "HG22"},
    ...
    {"LEU",
     PdbParser::Bond_pairs(
      {{"N", "CA"},     {"N", "H"},      {"N", "H2"},     {"CA", "C"},
       ...
       {"CG", "CD2"},   {"CG", "HG"},    {"CD1", "HD11"}, {"CD1", "HD12"},
  ...
  for(auto& compnd : Chain::Compound_iterator{*current_chain_ptr_}) {
