...
public:
  ...
  void
  reserve(GLuint size) override;

  void
  set_radius_data(GLintptr offset, GLsizeiptr size, const float* data);
...
protected:
  ...
  void
  enable_vertex_attribs(GLuint posloc,
                        GLuint normloc,
                        GLuint colloc,
                        GLuint radloc);

  void
  disable_vertex_attribs(GLuint posloc,
                         GLuint normloc,
                         GLuint colloc,
                         GLuint radloc);
};
