...
public:
  ...
  : public std::iterator<ChainMap::iterator::iterator_category,
                         ChainMap::iterator,
                         ChainMap::iterator::difference_type,
                         chain*,
                         chain&> {
  public:
    ...
    bool
    operator==(const chain_iterator& rhs);
  ...
  atom*
  getAtomBySerial(unsigned int serial);

  molecule&
  getMolecule() const;

  void
  addBond(atom& a1, atom& a2);
